...
export const ERRORS = {
  ...
  "team cannot contain email address": "ERRORS.TEAM_CANNOT_CONTAIN_EMAIL_ADDRESS",
  ...
  "participant not in nomination event": "ERRORS.PARTICIPANT_NOT_IN_NOMINATION_EVENT",
  "registration finished": "ERRORS.REGISTRATION_FINISHED",
  "participant already in nomination event": "ERRORS.PARTICIPANT_ALREADY_IN_NOMINATION_EVENT",
  "you are not in judge command": "ERRORS.YOU_ARE_NOT_IN_JUDGE_COMMAND",
  "race round length should be at least 1": "ERRORS.RACE_ROUND_LENGTH_SHOULD_BE_AT_LEAST_1",
  ...
  "participant does not belongs to owner": "ERRORS.PARTICIPANT_DOES_NOT_BELONG_TO_OWNER",
  ...
  "you cant not name team as default": "ERRORS.YOU_CANT_NOT_NAME_TEAM_AS_DEFAULT",
  "default team is unchangeable": "ERRORS.DEFAULT_TEAM_IS_UNCHANGEABLE",
  "team not in event nomination error": "ERRORS.TEAM_NOT_IN_EVENT_NOMINATION_ERROR",
  "participant already in team": "ERRORS.PARTICIPANT_ALREADY_IN_TEAM",
  "participant not in team": "ERRORS.PARTICIPANT_NOT_IN_TEAM",
  "participant present more then one time": "ERRORS.PARTICIPANT_PRESENT_MORE_THAN_ONE_TIME",
  ...
  "you are not allowed to perform this action": "ERRORS.YOU_ARE_NOT_ALLOWED_TO_PERFORM_THIS_ACTION",
  "passwords dont match": "ERRORS.PASSWORDS_DONT_MATCH",
  "current password is missed": "ERRORS.CURRENT_PASSWORD_IS_MISSED",
  "one or more judges presented in judges_ids not found": "ERRORS.JUDGES_NOT_FOUND",
  ...
  "user doesn't have acces for this operation": "ERRORS.USER_DOESNT_HAVE_ACCESS_FOR_THIS_OPERATION",
  "user is not a part of event organizers": "ERRORS.USER_IS_NOT_A_PART_OF_EVENT_ORGANIZERS",
  "photos uploaded successfully": "ERRORS.PHOTOS_UPLOADED_SUCCESSFULLY",
  "successfully deleted photos from event": "ERRORS.SUCCESSFULLY_DELETED_PHOTOS_FROM_EVENT",
  ...
  "this nomination event is not yours": "ERRORS.THIS_NOMINATION_EVENT_IS_NOT_YOURS",
  "judge not found in judges team error": "ERRORS.JUDGE_NOT_FOUND_IN_JUDGES_TEAM_ERROR",
  ...
  "educational institution cannot be none for non judge user": "ERRORS.EDUCATIONAL_INSTITUTION_CANNOT_BE_NONE_FOR_NON_JUDGE_USER",
